...
const translations: Translations = {
  en: {
    ...
    'Could not update \'{0}\'. Removed?': 'Could not update \'{0}\'. Removed?',
  ...
  es: {
    ...
    'Could not update \'{0}\'. Removed?': 'No se pudo actualizar \'{0}\'. ¿Eliminado?',
  ...
  fr: {
    ...
    'Could not update \'{0}\'. Removed?': 'Impossible de mettre à jour \'{0}\'. Supprimé?',
  ...
  de: {
    ...
    'Could not update \'{0}\'. Removed?': 'Konnte \'{0}\' nicht aktualisieren. Entfernt?',
